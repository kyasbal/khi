...
// InitializerIDInspectionTaskGraph mounts Connect-RPC InspectionTaskGraphService onto Gin engine.
const InitializerIDInspectionTaskGraph coreinit.InitializerID = "khi.default/inspection-task-graph"

// InspectionTaskGraphInitializer initializes and registers the InspectionTaskGraphService handlers.
var InspectionTaskGraphInitializer = &coreinit.Initializer{
	ID: InitializerIDInspectionTaskGraph,
...
func init() {
	coreinit.RegisterInitializer(InspectionTaskGraphInitializer)
}
