...
type RunContextOption = func(ctx context.Context, mode inspectioncore.InspectionTaskModeType) (context.Context, error)
...
func RunContextOptionFromValue[T any](key typedmap.TypedKey[T], value T) RunContextOption {
	return func(ctx context.Context, mode inspectioncore.InspectionTaskModeType) (context.Context, error) {
...
func RunContextOptionFromFunc[T any](key typedmap.TypedKey[T], f func(ctx context.Context, mode inspectioncore.InspectionTaskModeType) (T, error)) RunContextOption {
	return func(ctx context.Context, mode inspectioncore.InspectionTaskModeType) (context.Context, error) {
