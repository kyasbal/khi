...
func ResolveGraph(
	...
	return buildAndSortTaskSet(resolvedTasks, resolvedEdges, boundFanInRefIDsByTaskImpl), nil
}
...
func buildAndSortTaskSet(
	...
	return NewResolvedTaskSet(sortedTasks, edges, boundFanInRefIDsByTaskImpl)
}
