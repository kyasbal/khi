...
const file_khifile_v6_style_proto_rawDesc = "" +
	"\n" +
	"\x16khifile/v6/style.proto\x12\n" +
	"khifile.v6\"C\n" +
	"\tHDRColor4\x12\f\n" +
	...
	"shortLabel\x12@\n" +
	"\x10background_color\x18\x04 \x01(\v2\x15.khifile.v6.HDRColor4R\x0fbackgroundColor\x12@\n" +
	"\x10foreground_color\x18\x05 \x01(\v2\x15.khifile.v6.HDRColor4R\x0fforegroundColor\x12\x14\n" +
	"\x05order\x18\x06 \x01(\x05R\x05order\"\xca\x01\n" +
	"\x04Verb\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\rR\x02id\x12\x14\n" +
	"\x05label\x18\x02 \x01(\tR\x05label\x12@\n" +
	"\x10background_color\x18\x03 \x01(\v2\x15.khifile.v6.HDRColor4R\x0fbackgroundColor\x12@\n" +
	"\x10foreground_color\x18\x04 \x01(\v2\x15.khifile.v6.HDRColor4R\x0fforegroundColor\x12\x18\n" +
	...
	"\x10background_color\x18\x04 \x01(\v2\x15.khifile.v6.HDRColor4R\x0fbackgroundColor\x12@\n" +
	"\x10foreground_color\x18\x05 \x01(\v2\x15.khifile.v6.HDRColor4R\x0fforegroundColor\"\xe3\x01\n" +
	"\rRevisionState\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\rR\x02id\x12\x14\n" +
	"\x05label\x18\x02 \x01(\tR\x05label\x12\x12\n" +
	"\x04icon\x18\x03 \x01(\tR\x04icon\x12 \n" +
	"\vdescription\x18\x04 \x01(\tR\vdescription\x12@\n" +
	"\x10background_color\x18\x05 \x01(\v2\x15.khifile.v6.HDRColor4R\x0fbackgroundColor\x124\n" +
	"\x05style\x18\x06 \x01(\x0e2\x1e.khifile.v6.RevisionStateStyleR\x05style\"E\n" +
	"\x16AlphabeticalSortPolicy\x12+\n" +
	"\x11prioritized_names\x18\x01 \x03(\tR\x10prioritizedNames\"W\n" +
	"\x17ChronologicalSortPolicy\x12<\n" +
	"\x1achronological_search_depth\x18\x01 \x01(\x05R\x18chronologicalSearchDepth\">\n" +
	"\x1eGroupedChronologicalSortPolicy\x12\x1c\n" +
	"\tdelimiter\x18\x01 \x01(\tR\tdelimiter\"\xa4\x06\n" +
	"\fTimelineType\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\rR\x02id\x12\x14\n" +
	"\x05label\x18\x02 \x01(\tR\x05label\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\x12@\n" +
	"\x10background_color\x18\x04 \x01(\v2\x15.khifile.v6.HDRColor4R\x0fbackgroundColor\x12@\n" +
	"\x10foreground_color\x18\x05 \x01(\v2\x15.khifile.v6.HDRColor4R\x0fforegroundColor\x12\x18\n" +
	"\avisible\x18\x06 \x01(\bR\avisible\x12#\n" +
	"\rsort_priority\x18\a \x01(\x05R\fsortPriority\x12\x12\n" +
	"\x04icon\x18\b \x01(\tR\x04icon\x12\x16\n" +
	"\x06height\x18\t \x01(\x02R\x06height\x12R\n" +
	"\x1atype_chip_background_color\x18\n" +
	" \x01(\v2\x15.khifile.v6.HDRColor4R\x17typeChipBackgroundColor\x12R\n" +
	"\x1atype_chip_foreground_color\x18\r \x01(\v2\x15.khifile.v6.HDRColor4R\x17typeChipForegroundColor\x12U\n" +
	"\x13alphabetical_policy\x18\v \x01(\v2\".khifile.v6.AlphabeticalSortPolicyH\x00R\x12alphabeticalPolicy\x12X\n" +
	"\x14chronological_policy\x18\f \x01(\v2#.khifile.v6.ChronologicalSortPolicyH\x00R\x13chronologicalPolicy\x12n\n" +
	"\x1cgrouped_chronological_policy\x18\x0e \x01(\v2*.khifile.v6.GroupedChronologicalSortPolicyH\x00R\x1agroupedChronologicalPolicyB\x14\n" +
	"\x12sort_policy_config\"\xf4\x01\n" +
	"\tIconAtlas\x12&\n" +
	"\x0fmsdf_icon_image\x18\x01 \x03(\fR\rmsdfIconImage\x12\x1f\n" +
	"\vbmfont_json\x18\x02 \x01(\fR\n" +
	"bmfontJson\x12Y\n" +
	"\x12name_to_codepoints\x18\x03 \x03(\v2+.khifile.v6.IconAtlas.NameToCodepointsEntryR\x10nameToCodepoints\x1aC\n" +
	"\x15NameToCodepointsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\xdf\x02\n" +
	"\x12TimelineStyleChunk\x124\n" +
	"\n" +
	"severities\x18\x01 \x03(\v2\x14.khifile.v6.SeverityR\n" +
	"severities\x12&\n" +
	"\x05verbs\x18\x02 \x03(\v2\x10.khifile.v6.VerbR\x05verbs\x120\n" +
	"\tlog_types\x18\x03 \x03(\v2\x13.khifile.v6.LogTypeR\blogTypes\x12B\n" +
	"\x0frevision_states\x18\x04 \x03(\v2\x19.khifile.v6.RevisionStateR\x0erevisionStates\x12?\n" +
	"\x0etimeline_types\x18\x05 \x03(\v2\x18.khifile.v6.TimelineTypeR\rtimelineTypes\x124\n" +
	"\n" +
	"icon_atlas\x18\x06 \x01(\v2\x15.khifile.v6.IconAtlasR\ticonAtlas*\xa4\x01\n" +
	"\x12RevisionStateStyle\x12$\n" +
	" REVISION_STATE_STYLE_UNSPECIFIED\x10\x00\x12\x1f\n" +
	"\x1bREVISION_STATE_STYLE_NORMAL\x10\x01\x12 \n" +
	"\x1cREVISION_STATE_STYLE_DELETED\x10\x02\x12%\n" +
	"!REVISION_STATE_STYLE_PARTIAL_INFO\x10\x03BGZEgithub.com/GoogleCloudPlatform/khi/pkg/generated/khifile/v6;khifilev6b\beditionsp\xe8\a"
