...
var ReaderFactoryGeneratorTask = task.NewProcessorTask(ReaderFactoryGeneratorTaskID, []taskid.UntypedTaskReference{}, func(ctx context.Context, taskMode int, v *task.VariableSet) (*structure.ReaderFactory, error) {
