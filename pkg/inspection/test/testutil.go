...
func RunInspectionTask[T any](baseContext context.Context, task coretask.Task[T], mode inspectioncontract.InspectionTaskModeType, input map[string]any, taskDependencyValues ...task_test.TaskDependencyValues) (T, *typedmap.ReadonlyTypedMap, error) {
...
func RunInspectionTaskWithDependency[T any](baseContext context.Context, mainTask coretask.Task[T], dependencies []coretask.UntypedTask, mode inspectioncontract.InspectionTaskModeType, input map[string]any) (T, *typedmap.ReadonlyTypedMap, error) {
	taskCtx := khictx.WithValue(baseContext, inspectioncontract.InspectionTaskInput, input)
	taskCtx = khictx.WithValue(taskCtx, inspectioncontract.InspectionTaskMode, mode)
