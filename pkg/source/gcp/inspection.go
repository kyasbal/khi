...
import (
	...
	"github.com/GoogleCloudPlatform/kubernetes-history-inspector/pkg/source/gcp/task/gke/autoscaler"
	"github.com/GoogleCloudPlatform/kubernetes-history-inspector/pkg/source/gcp/task/gke/compute_api"
	"github.com/GoogleCloudPlatform/kubernetes-history-inspector/pkg/source/gcp/task/gke/gke_audit"
	"github.com/GoogleCloudPlatform/kubernetes-history-inspector/pkg/source/gcp/task/gke/k8s_audit"
	k8sauditquery "github.com/GoogleCloudPlatform/kubernetes-history-inspector/pkg/source/gcp/task/gke/k8s_audit/query"
	"github.com/GoogleCloudPlatform/kubernetes-history-inspector/pkg/source/gcp/task/gke/k8s_container"
	k8scontrolplanecomponent "github.com/GoogleCloudPlatform/kubernetes-history-inspector/pkg/source/gcp/task/gke/k8s_control_plane_component"
	...
	"github.com/GoogleCloudPlatform/kubernetes-history-inspector/pkg/source/gcp/task/private"
)

func commonPreparation(inspectionServer *inspection.InspectionTaskServer) error {
	err := inspectionServer.AddTaskDefinition(task.GCPApiClientTask)
	if err != nil {
		return err
	}
	...
	// required tasks
	err = inspectionServer.AddTaskDefinition(private.JustificationFormTask)
	if err != nil {
		return err
	}
	err = inspectionServer.AddTaskDefinition(private.FilenameHeaderMetadataGeneratorTask)
	if err != nil {
		return err
	}
