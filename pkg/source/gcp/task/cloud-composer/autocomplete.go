...
var AutocompleteClusterNames = task.NewCachedProcessor(taskid.NewImplementationID(gcp_task.AutocompleteClusterNamesTaskID, "composer"), []taskid.UntypedTaskReference{
