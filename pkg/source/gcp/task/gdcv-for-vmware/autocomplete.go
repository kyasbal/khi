...
var AutocompleteClusterNames = inspectiontaskbase.NewCachedTask(taskid.NewImplementationID(googlecloudk8scommon_contract.AutocompleteClusterNamesTaskID, "anthos-on-vmware"), []taskid.UntypedTaskReference{
