...
var AutocompleteClusterNames = task.NewCachedProcessor(taskid.NewImplementationID(gcp_task.AutocompleteClusterNamesTaskID, "anthos-on-aws"), []taskid.UntypedTaskReference{
