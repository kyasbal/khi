...
var AutocompleteClusterNames = task.NewCachedProcessor(taskid.NewImplementationID(gcp_task.AutocompleteClusterNamesTaskID, "gke"), []taskid.UntypedTaskReference{
