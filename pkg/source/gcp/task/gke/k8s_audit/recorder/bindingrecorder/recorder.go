...
func Register(manager *recorder.RecorderTaskManager) error {
	manager.AddRecorder("binding", []taskid.UntypedTaskReference{}, func(ctx context.Context, resourcePath string, l *types.ResourceSpecificParserInput, prevState any, cs *history.ChangeSet, builder *history.Builder, vs *task.VariableSet) (any, error) {
