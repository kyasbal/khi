...
func newTestK8sAuditLogFieldSet(verb *pb.Verb, apiVersion string, pluralKind string) k8saudit.K8sAuditLogFieldSet {
...
func TestLifeTimeTrackerTask(t *testing.T) {
	testCases := []struct {
		...
		inputK8sAuditLogFieldSet k8saudit.K8sAuditLogFieldSet
		...
		{
			desc:                     "create",
			inputK8sAuditLogFieldSet: newTestK8sAuditLogFieldSet(k8saudit.VerbCreate, "core/v1", "pods"),
			prevState:                nil,
		...
		},
		{
			...
			inputK8sAuditLogFieldSet: newTestK8sAuditLogFieldSet(k8saudit.VerbDelete, "core/v1", "pods"),
...
`,
		...
		},
		{
			...
			inputK8sAuditLogFieldSet: newTestK8sAuditLogFieldSet(k8saudit.VerbDeleteCollection, "core/v1", "pods"),
			resourceBodyYAML: `
status:
  phase: Running
`,
...
`,
		...
		},
		{
			...
			inputK8sAuditLogFieldSet: newTestK8sAuditLogFieldSet(k8saudit.VerbUpdate, "core/v1", "pods"),
			resourceBodyYAML: `
metadata:
  deletionTimestamp: "2023-10-26T10:00:00Z"
  finalizers:
...
`,
		...
		},
		{
			...
			inputK8sAuditLogFieldSet: newTestK8sAuditLogFieldSet(k8saudit.VerbPatch, "core/v1", "pods"),
...
`,
	...
	for _, tc := range testCases {
		t.Run(tc.desc, func(t *testing.T) {
			...
			resourceLog := &k8saudit.ResourceManifestLog{
				Log:                l,
