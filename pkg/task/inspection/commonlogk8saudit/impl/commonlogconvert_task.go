...
var CommonLogConvertTask = inspectiontaskbase.NewProgressReportableInspectionTask(commonlogk8saudit_contract.LogConvertTaskID, []taskid.UntypedTaskReference{
	...
	logs := coretask.GetTaskResult(ctx, commonlogk8saudit_contract.CommonAuitLogSource)
