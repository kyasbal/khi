...
func (c *containerLogToTimelineMapperTaskSetting) Process(ctx context.Context, passIndex int, event commonlogk8saudit_contract.ResourceChangeEvent, cs *history.ChangeSet, builder *history.Builder, state *containerLogToTimelineMapperTaskState) (*containerLogToTimelineMapperTaskState, error) {
	if state == nil {
...
func (c *containerLogToTimelineMapperTaskSetting) processFirstPass(ctx context.Context, event commonlogk8saudit_contract.ResourceChangeEvent, cs *history.ChangeSet, builder *history.Builder, state *containerLogToTimelineMapperTaskState) (*containerLogToTimelineMapperTaskState, error) {
...
func (c *containerLogToTimelineMapperTaskSetting) processSecondPass(ctx context.Context, event commonlogk8saudit_contract.ResourceChangeEvent, cs *history.ChangeSet, builder *history.Builder, state *containerLogToTimelineMapperTaskState) (*containerLogToTimelineMapperTaskState, error) {
...
func (c *containerLogToTimelineMapperTaskSetting) ResourcePairs(ctx context.Context, groupedLogs commonlogk8saudit_contract.ResourceManifestLogGroupMap) ([]commonlogk8saudit_contract.ResourcePair, error) {
	results := []commonlogk8saudit_contract.ResourcePair{}
	for _, group := range groupedLogs {
		// core/v1#pod#namespace#podnanme
		if group.Resource.APIVersion == "core/v1" && group.Resource.Kind == "pod" {
			results = append(results, commonlogk8saudit_contract.ResourcePair{
...
var _ commonlogk8saudit_contract.ManifestLogToTimelineMapperTaskSetting[*containerLogToTimelineMapperTaskState] = (*containerLogToTimelineMapperTaskSetting)(nil)
...
func (w *containerStateWalker) CheckAndRecord(stateReader *structured.NodeReader, cs *history.ChangeSet, commonLog *log.CommonFieldSet, k8sAuditLog *commonlogk8saudit_contract.K8sAuditLogFieldSet) {
