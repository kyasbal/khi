...
func (e *endpointResourceLogToTimelineMapperTaskSetting) Process(ctx context.Context, passIndex int, event commonlogk8saudit_contract.ResourceChangeEvent, cs *history.ChangeSet, builder *history.Builder, state *endpointResourceLogToTimelineMapperState) (*endpointResourceLogToTimelineMapperState, error) {
	if state == nil {
...
func (e *endpointResourceLogToTimelineMapperTaskSetting) processFirstPass(ctx context.Context, event commonlogk8saudit_contract.ResourceChangeEvent, cs *history.ChangeSet, builder *history.Builder, state *endpointResourceLogToTimelineMapperState) (*endpointResourceLogToTimelineMapperState, error) {
...
func (e *endpointResourceLogToTimelineMapperTaskSetting) processSecondPass(ctx context.Context, event commonlogk8saudit_contract.ResourceChangeEvent, cs *history.ChangeSet, builder *history.Builder, state *endpointResourceLogToTimelineMapperState) (*endpointResourceLogToTimelineMapperState, error) {
	...
	if event.EventType == commonlogk8saudit_contract.ChangeEventTypeTargetCreation && k8sFieldSet.K8sOperation.Verb != enum.RevisionVerbCreate {
...
func (e *endpointResourceLogToTimelineMapperTaskSetting) ResourcePairs(ctx context.Context, groupedLogs commonlogk8saudit_contract.ResourceManifestLogGroupMap) ([]commonlogk8saudit_contract.ResourcePair, error) {
