...
func (r *ResourceRevisionLogToTimelineMapperTaskSetting) Process(ctx context.Context, passIndex int, event commonlogk8saudit_contract.ResourceChangeEvent, cs *history.ChangeSet, builder *history.Builder, prevGroupData *resourceRevisionLogToTimelineMapperState) (*resourceRevisionLogToTimelineMapperState, error) {
	...
	case commonlogk8saudit_contract.ChangeEventTypeSourceDeletion:
		return &resourceRevisionLogToTimelineMapperState{}, r.handleParentChangeForSubresource(ctx, event, cs)
	case commonlogk8saudit_contract.ChangeEventTypeSourceModification:
		return &resourceRevisionLogToTimelineMapperState{}, r.handleParentChangeForSubresource(ctx, event, cs)
	case commonlogk8saudit_contract.ChangeEventTypeSourceCreation:
		return &resourceRevisionLogToTimelineMapperState{}, r.handleParentChangeForSubresource(ctx, event, cs)
	default:
...
var _ commonlogk8saudit_contract.ManifestLogToTimelineMapperTaskSetting[*resourceRevisionLogToTimelineMapperState] = (*ResourceRevisionLogToTimelineMapperTaskSetting)(nil)
...
func (r *ResourceRevisionLogToTimelineMapperTaskSetting) handleParentChangeForSubresource(ctx context.Context, event commonlogk8saudit_contract.ResourceChangeEvent, cs *history.ChangeSet) error {
	switch event.EventType {
	case commonlogk8saudit_contract.ChangeEventTypeSourceDeletion:
...
func (r *ResourceRevisionLogToTimelineMapperTaskSetting) handleTargetChange(ctx context.Context, event commonlogk8saudit_contract.ResourceChangeEvent, cs *history.ChangeSet, prevGroupData *resourceRevisionLogToTimelineMapperState) (*resourceRevisionLogToTimelineMapperState, error) {
	...
	if event.EventType == commonlogk8saudit_contract.ChangeEventTypeTargetCreation && commonFieldSet.Timestamp.Sub(creationTime) > r.minimumDeltaTimeToCreateInferredCreationRevision {
