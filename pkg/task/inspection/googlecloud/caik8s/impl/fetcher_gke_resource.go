...
var GKEResourceFetcherTask = inspectiontaskbase.NewInspectionTask(
	...
	func(ctx context.Context, taskMode inspectioncore.InspectionTaskModeType) ([]*caik8s.GKEResourceSnapshot, error) {
		...
		snapshots, err := fetchGKEResourceSnapshots(ctx, fetcher, cluster, startTime, endTime)
		if err != nil {
