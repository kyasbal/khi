...
var AnthosOnAWSClusterNamePrefixTask = coretask.NewTask(gkeonaws.ClusterNamePrefixTaskID, []coretask.Dependency{}, func(_ context.Context) (k8scommon.ClusterPrefixPolicy, error) {
