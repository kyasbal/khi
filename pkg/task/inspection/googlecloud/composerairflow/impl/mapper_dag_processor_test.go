	...
	}{
		{
			...
			asserts: []func(t *testing.T, ctx context.Context, cs *khifilev6.TimelineChangeSet){
				...
				func(t *testing.T, ctx context.Context, cs *khifilev6.TimelineChangeSet) {
					...
					timelinePath := composerairflow.MustAirflowDAGProcessorManagerInstanceTimeline(ctx, envPath, "/home/airflow/gcs/dags/airflow_monitoring.py", "unknown-parser")
					testchangeset.AssertTimeline(t, cs).
						HasRevision(timelinePath, &khifilev6.StagingRevision{
							...
							StateType:   composerairflow.RevisionStateComposerDagProcessorNoError,
						}, cmp.AllowUnexported(
