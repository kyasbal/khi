...
This package (`googlecloud/csm`) contains tasks for inspecting Cloud Service Mesh (CSM) traffic logs. It handles querying logs, parsing Envoy-related fields, and mapping them to KHI timeline events.
