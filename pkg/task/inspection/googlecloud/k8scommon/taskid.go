...
var AutocompleteLocationForClusterTaskID taskid.TaskImplementationID[*inspectioncore.AutocompleteResult[string]] = taskid.NewImplementationID(gcpcommon.AutocompleteLocationTaskID.Ref(), "location-for-k8s-cluster")
