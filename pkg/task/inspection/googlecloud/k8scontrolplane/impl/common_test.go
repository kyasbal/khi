	...
	testCases := []struct {
	...
	}{
		{
			...
			input: testlog.NewMockLog(
				...
				k8scontrolplane.K8sControlplaneCommonMessageFieldSet{
			...
			assert: func(t *testing.T, cs *khifilev6.LogChangeSet) {
				testchangeset.AssertLog(t, cs).
					...
					HasLogType(k8scontrolplane.LogTypeControlPlaneComponent).
		...
		},
		{
			...
			input: testlog.NewMockLog(
				testTime,
				k8scontrolplane.K8sControlplaneComponentFieldSet{
					ComponentName: "hpa-controller",
				},
				k8scontrolplane.K8sHPAControllerFieldSet{
