...
var _ googlecloudcaik8s_contract.CAIFetcher = (*caiFetcher)(nil)

// NewCAIFetcher creates a new generic CAIFetcher with the given client factory and call option injector.
func NewCAIFetcher(factory *googlecloud.ClientFactory, callOptionInjector *googlecloud.CallOptionInjector, defaultProjectID string) googlecloudcaik8s_contract.CAIFetcher {
	return &caiFetcher{
		factory:            factory,
