...
var (
	TimelineTypeAirflowTaskInstance = &khifilev4.TimelineType{
		Label:           "task",
		Description:     "Airflow Task Instance execution state",
		BackgroundColor: khifilev4.MustHDRColor4FromHex("#377E22FF"),
	...
	TimelineTypes = []*khifilev4.TimelineType{
		TimelineTypeAirflowTaskInstance,
	}
)
