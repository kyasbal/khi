...
var AutocompleteGDCVForVMWareClusterNamesTask = inspectiontaskbase.NewCachedTask(googlecloudclustergdcvmware_contract.AutocompleteGDCVForVMWareClusterNamesTaskID, []taskid.UntypedTaskReference{
	googlecloudclustergdcvmware_contract.ClusterListFetcherTaskID.Ref(),
	...
	if projectID != "" {
		clusterListFetcher := coretask.GetTaskResult(ctx, googlecloudclustergdcvmware_contract.ClusterListFetcherTaskID.Ref())
