...
var AutocompleteMetricsK8sContainerTask = coretask.NewTask(googlecloudclustergke_contract.AutocompleteMetricsK8sContainerTaskIDForGKE, []coretask.Dependency{}, func(ctx context.Context) (string, error) {
...
var AutocompleteMetricsK8sNodeTask = coretask.NewTask(googlecloudclustergke_contract.AutocompleteMetricsK8sNodeTaskIDForGKE, []coretask.Dependency{}, func(ctx context.Context) (string, error) {
