...
var (
	TimelineTypeControlPlaneComponent = &khifilev4.TimelineType{
		Label:           "controlplane",
		Description:     "Control plane component timeline",
		BackgroundColor: khifilev4.MustHDRColor4FromHex("#FF5555FF"),
	...
	TimelineTypes = []*khifilev4.TimelineType{
		TimelineTypeControlPlaneComponent,
	}
)
