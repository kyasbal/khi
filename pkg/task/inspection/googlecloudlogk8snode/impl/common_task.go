...
// newNodeNameAndProcessTypeGrouperTask creates a new grouper task with grouping by node name.
func newNodeNameAndProcessTypeGrouperTask(taskid taskid.TaskImplementationID[inspectiontaskbase.LogGroupMap], logSource taskid.TaskReference[[]*log.Log]) coretask.Task[inspectiontaskbase.LogGroupMap] {
